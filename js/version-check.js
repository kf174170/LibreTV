...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://raw.ihtw.moe/raw.githubusercontent.com/kf174170/TYsonTV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/kf174170/TYsonTV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/kf174170/TYsonTV', '_blank');
                    });
                }
            }, 100);
        } else {
